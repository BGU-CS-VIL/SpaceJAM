...
class ViTExtractor:
    ...
    def create_model(model_type: str) -> nn.Module:
        ...
        if 'v2' in model_type:
            ...
            model = torch.hub.load('facebookresearch/dino:main', model_type, force_reload=True)
    ...
    def _register_hooks(self, layers: List[int], facet: str) -> None:
        ...
        """
        if layers[0] != len(self.model.blocks) - 1:
            print(f'Warning: extracting features from layer {layers[0]} instead of the last layer {len(self.model.blocks) - 1}')
